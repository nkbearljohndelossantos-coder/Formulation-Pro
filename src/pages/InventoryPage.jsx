...
export function InventoryPage() {
  ...
  const fetchData = () => {
    ...
    if (activeTab === 'rejected') {
      url = `/api/v1/inventory/rejected?search=${encodeURIComponent(search)}&disposition=${encodeURIComponent(dispositionFilter)}&status=${encodeURIComponent(statusFilter)}`;
    }
  ...
  useEffect(() => {
    fetchData();
  }, [activeTab, search, locationFilter, statusFilter, dispositionFilter]);
